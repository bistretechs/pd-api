...
class QuoteLineItem(models.Model):
    ...
    product = models.ForeignKey('clientapp.Product', on_delete=models.SET_NULL, null=True, blank=True, related_name='quote_line_items')
...
class DesignSession(models.Model):
    ...
    product = models.ForeignKey('clientapp.Product', on_delete=models.CASCADE)
...
class Promotion(models.Model):
    ...
    # Eligibility
    eligible_products = models.ManyToManyField('clientapp.Product', blank=True, related_name='promotions')
...
class MaterialInventory(models.Model):
    ...
    spec_option = models.ForeignKey(
        'clientapp.SpecOption',
        on_delete=models.SET_NULL,
...
class ClientOrderItem(models.Model):
    ...
    product = models.ForeignKey('clientapp.Product', on_delete=models.PROTECT)
